...
var squares = [createSquare(w - 150, h - 150), createSquare(w + 150, h - 150), createSquare(w + 150, h + 150), createSquare(w - 150, h + 150)];
var quad = squares.map(function (s) {
  return s.position;
}); // add sprite itself

var containerSprite = new PIXI.projection.Sprite2s(PIXI.Texture.from('examples/assets/bg_scene_rotate.jpg'));
...
var bunny = new PIXI.projection.Sprite2s(PIXI.Texture.from('examples/assets/flowerTop.png'));
bunny.anchor.set(0.5);
containerSprite.addChild(bunny);
addInteraction(bunny); // === INTERACTION CODE  ===
