...
document.body.appendChild(app.view); // === FIRST PART ===
// just simple rotation

var sprite = new PIXI.projection.Sprite2d(PIXI.Texture.from('examples/assets/flowerTop.png'));
...
var sprite2 = new PIXI.projection.Sprite2d(PIXI.Texture.from('examples/assets/flowerTop.png'));
...
var sprite3 = new PIXI.projection.Sprite2d(PIXI.Texture.from('examples/assets/eggHead.png'));
