...
layer.useRenderTexture = true; // this flag is required, or you'll get
...
var bunnyTex = PIXI.Texture.from('examples/assets/bunny.png');
var bunnies = [];
...
app.ticker.add(function (delta) {
  ...
  for (var _i = 0; _i < bunnies.length; _i++) {
    bunnies[_i].rotation += 0.05 * delta;
    bunnies[_i].children[0].rotation += 0.1 * delta;
  }
});