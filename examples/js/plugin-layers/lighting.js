...
var HEIGHT = H / resolution; // the plugin is here: https://github.com/pixijs/pixi-display/tree/layers, its WIP
...
document.body.appendChild(app.view); // create the stage instead of container

app.stage = new PIXI.display.Stage();
var background = new PIXI.TilingSprite(PIXI.Texture.from('examples/assets/p2.jpeg'), WIDTH, HEIGHT);
app.stage.addChild(background); // make container for bunnies
...
var bunnyTexture = PIXI.Texture.from('examples/assets/bunny.png');
