...
document.body.appendChild(app.view); // compressed textures setup
...
function createSprite(texture, text) {
  ...
  sprite.on('click', function () {
    _this.alpha = 1.7 - _this.alpha;
  });
  return sprite;
}

loader.add('house_png', 'examples/assets/pixi-compressed-textures/dracula_house_4.png').add('house_png_2', 'examples/assets/pixi-compressed-textures/dracula_house_4.png?v=2').add('house_dds', 'examples/assets/pixi-compressed-textures/dracula_house_4.dds', {
  crossOrigin: true
}).add('house_dds_2', 'examples/assets/pixi-compressed-textures/dracula_house_4.dds?v=2', {
  crossOrigin: true
}).load(function (loaderInstance, resources) {
  ...
  resources.house_dds_2.texture.baseTexture.premultiplyAlpha = false; // just a hack to actually show the consequences of wrong value of the flag
