...
var sprite = PIXI.Sprite.from('examples/assets/bg_rotate.jpg'); // // BEZIER CURVE ////
...
app.stage.addChild(bezier); // // BEZIER CURVE 2 ////
...
rectAndHole.endHole();
rectAndHole.endFill();
app.stage.addChild(rectAndHole); // // Line Texture Style ////
