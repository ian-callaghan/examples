...
PIXI.Loader.shared.add('examples/assets/eggHead.png', 'examples/assets/eggHead.png').add('examples/assets/flowerTop.png', 'examples/assets/flowerTop.png').add('examples/assets/helmlok.png', 'examples/assets/helmlok.png').add('examples/assets/skully.png', 'examples/assets/skully.png').load(onAssetsLoaded);
var REEL_WIDTH = 160;
var SYMBOL_SIZE = 150; // onAssetsLoaded handler builds the example.

function onAssetsLoaded() {
  // Create different slot symbols.
  var slotTextures = [PIXI.Texture.from('examples/assets/eggHead.png'), PIXI.Texture.from('examples/assets/flowerTop.png'), PIXI.Texture.from('examples/assets/helmlok.png'), PIXI.Texture.from('examples/assets/skully.png')]; // Build the reels
  ...
  for (var i = 0; i < 5; i++) {
    ...
    for (var j = 0; j < 4; j++) {
      var symbol = new PIXI.Sprite(slotTextures[Math.floor(Math.random() * slotTextures.length)]); // Scale the symbol to fit symbol area.
